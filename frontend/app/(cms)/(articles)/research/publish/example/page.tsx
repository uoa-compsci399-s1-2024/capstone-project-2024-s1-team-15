...
export default function ExampleCreateResearchPage() {
    ...
    return (
        <div>
            <h1>Publish a Research Article - Example</h1>
            <ButtonLink href={"/research/publish"} text={"Back"} />
            <ArticleForm articleType={ArticleType.research} article={exampleArticle} actionType={"publish"} />
        </div>
    )
}
