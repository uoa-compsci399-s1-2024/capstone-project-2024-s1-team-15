        ...
        <>
            ...
            `}>
                ...
                `}
                    ...
                    <div className={"m-1.5 p-2.5 sm:m-2 sm:p-3 md:m-2.5 md:p-4 rounded-xl"}>{navIcon}</div>
                </button>
                ...
                <div className={"md:flex-grow"}>
                    <Link href={"/"} className="text-black p-4">
                        <span
                            className={
                                "font-bold text-2xl sm:text-4xl md:text-5xl text-black tracking-tight select-none"
                            }>
                            AAPC
                        </span>
                    </Link>
                ...
                `}
                    ...
                    <div className={"m-1.5 p-2.5 sm:m-2 sm:p-3 md:m-2.5 md:p-4 rounded-xl"}>{authIcon}</div>
                </button>
            </div>
        </>
    )
