            ...
            <form onSubmit={sendEmail} className="space-y-4" id={"contact-form"}>
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 border-2 rounded-lg focus:border-primary hover:border-accent-dark"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-2 border-2 rounded-lg focus:border-primary hover:border-accent-dark h-32"
