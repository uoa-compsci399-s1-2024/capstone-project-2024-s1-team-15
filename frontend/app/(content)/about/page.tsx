...
export default function About() {
    return (
        <>
            ...
            <div className="about-page max-w-screen-xl mx-auto prose">
                <p>
                ...
                <section className="flex flex-col md:flex-row md:flex-wrap gap-x-4 gap-y-6 not-prose mb-12">
                    {profiles.map(p => (
                ...
                <figure className="flex flex-col justify-center items-center mt-4">
                    ...
                    <figcaption className="flex-1 text-center mt-2 text-balance max-w-96">
                        <p className={"smaller"}>
                ...
                <div className="mt-6 flex gap-6 flex-wrap items-center justify-center">
                    <OrganisationImage
...
function OrganisationImage({ name, websiteLink, logoImage }: { name: string, websiteLink: string, logoImage: StaticImport }) {
    return (
        <div className="h-full">
            <Link className="inline-block" href={websiteLink} target="_blank">
    ...
    return (
        <article className="p-5 flex-1 basis-[16rem] relative z-0 shadow-lg border rounded-md transition-all hover:shadow-sm bg-white">
            ...
            <div className="mt-4">
                ...
                <p className="text-gray-900 font-semibold mt-5">About Me</p>
