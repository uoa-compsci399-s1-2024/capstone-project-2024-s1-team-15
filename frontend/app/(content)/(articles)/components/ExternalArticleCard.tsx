...
export default function ExternalArticleCard({ article }: { article: IArticle }): React.JSX.Element {
    return (
        <Link
            href={`/${article.articleType === ArticleType.news_external ? "news" : "research"}/${article.id}`}
