...
export default function AllResearchPage() {
    return (
        <>
            ...
            <p className="prose mb-4">Stay informed with AAPC: Access our latest projects, ongoing research, and a curated selection of published studies in the field of pollen.</p>
